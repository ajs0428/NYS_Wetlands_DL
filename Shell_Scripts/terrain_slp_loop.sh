...
include=(12 22 51 53 56 60 64 67 84 86 90 92 102 105 116 120 123 136 138 152 176 183 189 192 193 198 218 225 250)
...
for number in "${include[@]}"; do
    ...
    "slp" \
    "Data/TerrainProcessed/HUC_TerrainMetrics/" > "Shell_Scripts/terrain_slp.log" 2>&1
